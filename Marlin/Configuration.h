...
#define STRING_CONFIG_H_AUTHOR "(Christoph-D)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // i3 Mega with E3D V6 hotend
  #define DEFAULT_Kp 11.56
  #define DEFAULT_Ki 0.61
  #define DEFAULT_Kd 54.95
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 469 }
...
// A little smaller because my BLTouch probe sticks out to the right.
